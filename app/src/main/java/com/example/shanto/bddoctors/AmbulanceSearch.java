 ...
 */
public class AmbulanceSearch extends Activity{
    private Spinner spinner1, spinner2;
    private Button button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ambulance_search);
...
//                        Toast.LENGTH_SHORT).show();
               ...
               //String specialField=spinner2.getSelectedItem().toString();
                ...
                Intent intent=new Intent(AmbulanceSearch.this,ListAmbulance.class);
